 ...
 */
class getCheckAttendanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CheckAttendanceRepository' shared autowired service.
     *
     * @return \App\Repository\CheckAttendanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CheckAttendanceRepository.php';

        return $container->privates['App\\Repository\\CheckAttendanceRepository'] = new \App\Repository\CheckAttendanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
