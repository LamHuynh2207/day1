...
class Product extends \App\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'ProductName', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'Price'];
        }
     ...
     * {@inheritDoc}
     */
    public function setId(int $Id): \App\Entity\Product
    {
